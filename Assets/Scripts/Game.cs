...
public static class Game
{
    ...
    {
        Game.Points = 0;
        SceneManager.LoadScene("NormalGame", LoadSceneMode.Single);
    }
    ...
    public static void GenerateGame()
    {
        ...
        AutoGenerated = true;
        InputSettings.AutoCalibrate();
        SceneManager.LoadScene("GeneratedGame", LoadSceneMode.Single);
    }
    ...
    public static void CheckPoints()
    {
        if (Points == MaxPoints)
        {
            ...
            SceneManager.LoadScene("CompletedScreen", LoadSceneMode.Single);
        }
    }
}
